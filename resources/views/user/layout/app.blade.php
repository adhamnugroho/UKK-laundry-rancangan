...
<head>
    ...
    <link href="{{ asset('template-user/css/bootstrap-icons.css') }}" rel="stylesheet">

    <link href="{{ asset('template-user/css/tooplate-clean-work.css') }}" rel="stylesheet">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <p><a href="#">Clean Work</a> is a Bootstrap v.5.1.3 HTML CSS template for free download
                            provided by Tooplate. You can use this layout for any purpose. Images are taken from <a
                                ...
                                rel="nofollow" href="https://worldvectorlogo.com/"
                                target="_blank">WorldVectorLogo</a> websites.</p>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="featured-block">
                            <div class="d-flex align-items-center mb-3">
                                <img src="{{ asset('template-user/images/avatar/happy-customer-01.jpg') }}"
                        ...
                        <div class="featured-block mb-lg-0">
                            <div class="d-flex align-items-center mb-3">
                                <img src="{{ asset('template-user/images/avatar/happy-customer-02.jpg') }}"
                                    class="avatar-image img-fluid">
        ...
        <section class="partners-section">
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-2 col-md-4 col-6">
                        <img src="{{ asset('template-user/images/partners/glorix.svg') }}"
                            class="partners-image img-fluid">
                    </div>
                    ...
                    <div class="col-lg-2 col-md-4 col-6">
                        <img src="{{ asset('template-user/images/partners/unilabs.svg') }}"
                            class="partners-image img-fluid">
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-12 d-flex align-items-center mb-4 pb-2">
                    <div>
                        <img src="{{ asset('template-user/images/bubbles.png') }}" class="logo img-fluid"
                            alt="">
                    </div>
